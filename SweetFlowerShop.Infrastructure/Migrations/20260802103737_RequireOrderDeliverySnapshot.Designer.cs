...
namespace SweetFlowerShop.Infrastructure.Migrations
{
    ...
    [Migration("20260802103737_RequireOrderDeliverySnapshot")]
    partial class RequireOrderDeliverySnapshot
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SweetFlowerShop.Domain.Entities.CartItem", b =>
                {
                    ...
                    b.HasOne("SweetFlowerShop.Domain.Entities.Product", "Product")
                        .WithMany()
